...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form>
            <div class="modal-body" id="filter-node">
                ...
                <button type="button" class="btn btn-primary filter" onclick="filter()" id ="thisisbutton"><spring:message code="meal.filter"/></button>
                <button type="button" class="btn btn-primary filter" onclick="updateTable()" id ="filter-button"><spring:message code="meal.resetFilter"/></button>
            </div>
        </form>
        <hr>
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr class="table-row" data-mealExcess="${meal.excess}" id="${meal.id}">
                    <td>
