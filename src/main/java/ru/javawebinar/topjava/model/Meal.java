...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT meal FROM Meal meal WHERE meal.user.id=:user_id AND meal.dateTime BETWEEN :start_date AND :end_date")
})
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String GET_ALL = "Meal.getAllSortedByDate";
